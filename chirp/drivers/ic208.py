...
CHARSET = dict(list(zip([0x00, 0x08, 0x09, 0x0a, 0x0b, 0x0d, 0x0f], list(" ()*+-/"))) +
               list(zip(list(range(0x10, 0x1a)), list("0123456789"))) +
               [(0x1c, '|'), (0x1d, '=')] +
               list(zip(list(range(0x21, 0x3b)), list("ABCDEFGHIJKLMNOPQRSTUVWXYZ"))))
